...
RAMDISK_MODULES = $(addprefix device/samsung/sc02c/,dhd.ko scsi_wait_scan.ko)
...
PRODUCT_COPY_FILES += $(foreach module,\
	$(filter-out $(RAMDISK_MODULES),$(wildcard device/samsung/sc02c/*.ko)),\
	$(module):system/lib/modules/$(notdir $(module)))

ifeq ($(TARGET_PREBUILT_KERNEL),)
    LOCAL_KERNEL := device/samsung/sc02c/kernel
else
...
PRODUCT_COPY_FILES += \
	device/samsung/sc02c/vold.fstab:system/etc/vold.fstab
